...
import { PathEquipAnalyse, PathHeroData, PathHeroTemplateAnalyse, PathHeroTemplateCreate, PathHeroTemplateManage, PathHeroTemplatePublic, PathHeroTemplateUpdate, PathIDParam, PathLogin, PathMain } from "./const";
      ...
      <Content style={{ background: 'rgb(240,255,255)', padding: '30px' }}>
        <BrowserRouter>
          <Routes>
            ...
            <Route path={PathEquipAnalyse} element={<EquipAnalyse/>}></Route>
